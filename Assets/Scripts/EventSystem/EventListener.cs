...
public class EventAndResponse
{
    ...
    public void EventRaised()
    {
        ...
        {
            //GROS CACA BUG invoke ne passe pas le sentString qui est bien présent.
            GameObject UIObj = GameObject.Find("UIOverlay");
            if (UIObj != null) UIObj.GetComponent<UIManager>().MyString = gameEvent.sentString;
