...
public class MazeGenerator : MonoBehaviour
{
    ...
    private void SpawnNMy(Vector3 spawnPosition)
    {
        ...
        if (enemy1 != null)
        {
            ...
            enemy1.transform.localScale = new Vector3(1f,1f,1f);
    ...
    public void CreateLayout()
    {
        ...
        for (int x = 1; x <= mazeColumns; x++)
        {
            for (int y = 1; y <= mazeRows; y++)
            {
                ...
                {
                    SpawnNMy(new Vector3(spawnPos.x, spawnPos.y,0f));
                }
    ...
    public void MakeExit()
    {
        ...
        var e = Instantiate(Boss);
        e.transform.position = new Vector3(newCell.gridPos.x, newCell.gridPos.y, 0f);
        //e.transform.
